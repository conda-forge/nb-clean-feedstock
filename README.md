...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/nb-clean-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15599&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/nb-clean-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `nb-clean` can be installed with:

```
conda install nb-clean
```

It is possible to list all of the versions of `nb-clean` available on your platform with:
